...
with open(args.file, "r") as file:
    ...
    print(
        f"The elf carrying the most calories is the holding {first_answer} calories")
    print(
        f"The top 3 elves carrying the most calories are holding {second_answer} calories")
